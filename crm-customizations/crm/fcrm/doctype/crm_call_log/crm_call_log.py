...
class CRMCallLog(Document):
	...
	def as_dict(self, *args, **kwargs):
		...
		if recording_url:
			# Hostyo customization: Telnyx recordings are downloaded and
			# re-hosted as a *private* Frappe File (see
			# pbx_integration.telnyx._save_recording) instead of pointing
			# at Telnyx's own short-lived URL. The stock proxy below always
			# makes *this server* fetch whatever recording_url holds - a
